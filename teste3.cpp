...
void CadastrarTutor(Tutor vetTutor[]){
    ...
    cout << "Nome: " ;
    cin.ignore();
	getline(cin, vetTutor[contID].nome);
	cout << "\nEndereco: ";
	getline(cin, vetTutor[contID].endereco);
...
void CadastrarAnimal(Animal vetAnimal[], Tutor vetTutor[]){
    ...
    cout << "Nome: " ;
    cin.ignore();
	getline(cin, vetAnimal[contA].nome);
	cout << "\nEspecie: ";
	getline(cin, vetAnimal[contA].especie);
	cout << "\nIdade: ";
